      ...
      <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::model($data, ['route' => ['absen.update', $data->id], 'method' => 'PUT']) !!}
            {{ csrf_field() }}
              <div class="box-body">
                <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                  {{ Form::label('nama', 'Nama') }}
                  {{ Form::text('nama', $data->siswa->nama, ['class' => 'form-control', 'readonly' => '']) }}
                  @if($errors->has('nama'))
              ...
              <div class="box-footer">
                ...
                <a href="{{ route('absen.index') }}" class="btn btn-danger pull-right">Batal</a>
              </div>
            {!! Form::close() !!}
